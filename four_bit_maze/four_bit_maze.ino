...
#define BUTTON_0 2 // pin for button 0
#define BUTTON_1 3 // pin for button 1
#define BUTTON_2 4 // pin for button 2
#define BUTTON_3 5 // pin for button 3
#define RESET 6 // pin for reset button 
#define NEW_MAZE 7 // pin for new maze button 
#define LED_0 8 // pin for LED 0
#define LED_1 9 // pin for LED 1
#define LED_2 12 // pin for LED 2
#define LED_3 11 // pin for LED 3
